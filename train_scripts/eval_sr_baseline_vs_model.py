...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default=os.path.join(PROJECT_ROOT, "experiments_results/train_sigma_sr_vpred/checkpoints/epoch059_psnr22.77_lp0.4354.pth"))
